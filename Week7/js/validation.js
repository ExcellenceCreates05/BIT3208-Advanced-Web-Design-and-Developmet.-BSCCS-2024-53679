 ...
 * validation.js — Client-Side Validation + DOM Manipulation
 * Covers: Week 2 (GUI interaction) + Week 3 (JS/DOM tasks)
 * =============================================================
 *
 * WHAT THIS FILE DOES:
 *   1. Login form validation
 *   2. Add/Edit book form validation
 *   3. Requisition quantity validation
 *   4. Live table search/filter (DOM manipulation)
 *   5. Modal open/close logic (DOM manipulation)
 *   6. Select-all checkbox logic
 *   7. Delete confirmation with dynamic modal population
 */
